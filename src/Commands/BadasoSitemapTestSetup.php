...
class BadasoSitemapTestSetup extends Command
{
    public static $PHPUNIT_XML_PATH = 'phpunit.xml';
    public static $BADASO_UNIT_TEST_PATHS = [
        './vendor/badaso/sitemap-module/tests/Unit',
    ];
    public static $BADASO_FEATURE_TEST_PATHS = [
        './vendor/badaso/sitemap-module/tests/Feature',
    ];
     ...
     * @var string
     */
    protected $signature = 'badaso-sitemap-test:setup';
